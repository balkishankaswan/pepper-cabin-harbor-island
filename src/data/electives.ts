import type { Elective, TrackId } from "./types";

const all = (tag: Elective["tracks"][TrackId]): Elective["tracks"] => ({
  embedded: tag,
  power: tag,
  drives: tag,
  control: tag,
...
export const electives: Elective[] = [
  {
    ...
    kind: "PE",
    l: 3, t: 0, p: 0, c: 3,
    tracks: { ...all("skip"), control: "take", drives: "consider" },
  ...
  },
  {
    ...
    kind: "PE",
    l: 3, t: 0, p: 0, c: 3,
    tracks: { ...all("skip"), control: "take", drives: "consider", space: "consider" },
  ...
  },
  {
    ...
    kind: "PE",
    l: 3, t: 0, p: 0, c: 3,
    tracks: { ...all("consider"), vlsi: "take", comms: "take", control: "take" },
  ...
  },
  {
    ...
    kind: "PE",
    l: 3, t: 0, p: 0, c: 3,
    tracks: { ...all("consider"), control: "take", power: "consider" },
  ...
  },
  {
    ...
    kind: "PE",
    l: 3, t: 0, p: 0, c: 3,
    tracks: { ...all("consider"), comms: "take", control: "take", vlsi: "take", embedded: "consider" },
  ...
  },
  {
    ...
    kind: "PE",
    l: 3, t: 0, p: 0, c: 3,
    tracks: { ...all("skip"), control: "take", space: "consider" },
  ...
  },
  {
    ...
    kind: "PC/PE",
    l: 3, t: 0, p: 0, c: 3,
    tracks: { ...all("skip"), power: "consider" },
  ...
  },
  {
    ...
    kind: "PC/PE",
    l: 3, t: 0, p: 0, c: 3,
    tracks: { ...all("skip"), drives: "take", power: "consider" },
  ...
  },
  {
    ...
    kind: "PC/PE",
    l: 3, t: 0, p: 0, c: 3,
    tracks: { ...all("consider"), power: "take", drives: "take", space: "take", analog: "consider" },
  ...
  },
  {
    ...
    kind: "PE",
    l: 3, t: 0, p: 0, c: 3,
    tracks: { ...all("consider"), drives: "take", embedded: "consider", control: "consider" },
  ...
  },
  {
    ...
    kind: "PE",
    l: 3, t: 0, p: 0, c: 3,
    tracks: { ...all("skip"), power: "take", space: "consider" },
  ...
  },
  {
    ...
    kind: "PE",
    l: 3, t: 0, p: 0, c: 3,
    tracks: { ...all("skip"), power: "consider", embedded: "consider" },
  ...
  },
  {
    ...
    kind: "PE",
    l: 3, t: 0, p: 0, c: 3,
    tracks: { ...all("consider"), comms: "take", space: "take", vlsi: "consider" },
  ...
  },
  {
    ...
    kind: "PE",
    l: 3, t: 0, p: 0, c: 3,
    tracks: { ...all("take"), comms: "take", analog: "take", space: "take", power: "take" },
  ...
  },
  {
    ...
    kind: "PE",
    l: 3, t: 0, p: 0, c: 3,
    tracks: { ...all("skip"), comms: "take", space: "consider", control: "consider" },
  ...
  },
  {
    ...
    kind: "PE",
    l: 3, t: 0, p: 0, c: 3,
    tracks: { ...all("skip"), comms: "take", space: "take", analog: "consider" },
  ...
  },
  {
    ...
    kind: "PE",
    l: 3, t: 0, p: 0, c: 3,
    tracks: { ...all("skip"), comms: "take", control: "consider", vlsi: "skip" },
  ...
  },
  {
    ...
    kind: "PC",
    l: 0, t: 0, p: 3, c: 2,
    tracks: { ...all("consider"), comms: "take", space: "take" },
  ...
  },
  {
    ...
    kind: "PE",
    l: 3, t: 0, p: 0, c: 3,
    tracks: { ...all("consider"), vlsi: "take", embedded: "take", comms: "consider", space: "consider" },
...
export function electiveAdvice(track: TrackId) {
  const take = electives.filter((e) => e.tracks[track] === "take");
  const consider = electives.filter((e) => e.tracks[track] === "consider");
  const skip = electives.filter((e) => e.tracks[track] === "skip");
  return { take, consider, skip };
}
